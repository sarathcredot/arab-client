  ...
  return (
    <>
      ...
      >
        ...
        >
          <h4 className="section-title text-transform-none mb-0 mr-0">50% Off</h4>
        ...
        >
          ...
          >
            {fiftyPercentProducts
              ? fiftyPercentProducts.map((item, index) => (
                  <ProductOne
      ...
      >
        <div
          ...
          style={{ borderBottom: "1px solid ", borderColor: "#EEEEEE", justifyContent: "space-between" }}
        >
          <h4 className="section-title text-transform-none mb-0 mr-0">30% Off</h4>
          <Link href="/shop?discount=10">
            <a
              style={{
                display: "inline-flex",
      ...
      >
        <div
          ...
          style={{ borderBottom: "1px solid ", borderColor: "#EEEEEE", justifyContent: "space-between" }}
        >
          <h4 className="section-title text-transform-none mb-0 mr-0">10% Off</h4>
          <Link href="/shop?discount=10">
            <a
              style={{
                display: "inline-flex",
