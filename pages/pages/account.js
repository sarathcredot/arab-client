            ...
            <div className="col-12 container order-1 tab-content mb-2">
              <TabPanel className="tab-pane fade" id="dashboard">
                <div className="dashboard-content">
                  {/* Dashboard content */}
                  <p
                    style={{fontSize:"26px",fontWeight:"normal",margin:0}}
                  >
                    Hello{" "}
                      ...
                      <div className="dashboard_box_container p-md-5 p-sm-0 ">
                        ...
                        >
                            ...
                            <div className="feature-box-content" style={{ marginTop: "20px" }}>
                              <h3 style={{fontSize:"16px"}}>ORDERS</h3>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div className="feature-box-content" style={{ marginTop: "20px" }}>
                              <h3 style={{fontSize:"16px"}}>WISHLIST</h3>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div className="feature-box-content" style={{ marginTop: "20px" }}>
                              <h3 style={{fontSize:"16px"}}>ADDRESS</h3>
                            </div>
                        </div>
                        <div
                        onClick={()=>{router.push("/pages/accountdetails")}} 
                          className="dashboard_box "
                        >
                            <div
                              style={{
                            ...
                            <div className="feature-box-content" style={{ marginTop: "20px" }}>
                              <h3 style={{fontSize:"16px"}}>ACCOUNT DETAILS</h3>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            <div className="feature-box-content" style={{ marginTop: "20px" }}>
                              <h3 style={{fontSize:"16px"}}>DELETE ACCOUNT</h3>
                            </div>
                        </div>
                        <div
                          className="dashboard_box "
                        ...
                        >
                            ...
                            <div className="feature-box-content" style={{ marginTop: "20px" }}>
                              <h3 style={{fontSize:"16px"}}>LOGOUT</h3>
                            </div>
                        </div>
                      </div>
                  </div>
